...
L1DataEval::~L1DataEval(void)
{
}

void L1DataEval::waitUntilReady() 
{
    latch.await();
}
...
void L1DataEval::onMessage( const Message* message )
{
    try
    {
...
void L1DataEval::onException( const CMSException& ex AMQCPP_UNUSED) 
{
